...
> Calculates change due for each denomation contained in the state of the component and prints the number of denomations to the correct area of the application.
